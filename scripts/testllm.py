...
if uploaded_file is not None:
    ...
    if "messages" not in st.session_state:
        ...
        ################### ADD THIS: Check for follow-up question before displaying messages ###################
    if st.session_state.followup_question:
        ...
        Provide only breif information and dont overthink the question. Provide only simple responses.
        Data (first 10 rows):
